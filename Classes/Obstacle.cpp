...
Obstacle::Obstacle(std::string texture, float x, float y, float width, float height) : GameObject(texture, x, y, width, height) {

}

void Obstacle::render(cocos2d::Sprite* background) {
